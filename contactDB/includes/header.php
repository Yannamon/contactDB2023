...
<!-- <link href="<?php echo BASE_URL ?>css/bootstrap-lumen.css" rel="stylesheet"> -->
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4 fixed-top mx-auto mt-3 rounded"  style="width: 500px;">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              <a class="dropdown-item" href="<?php echo BASE_URL ?>admin/insert-min.php">Insert</a>
